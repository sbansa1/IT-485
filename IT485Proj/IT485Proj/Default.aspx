<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="IT485Proj._Default" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">

     <div class="jumbotron">  
        <asp:Image ID="Image1" runat="server" CssClass="img-responsive" Height="100%" ImageUrl="~/Logo/Art.jpg" Width="100%" />
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <p>
                <a class="btn btn-default" href="About.aspx">About THEARTSTORE&raquo;</a>
            </p>
        </div>
        <div class="col-md-4">
