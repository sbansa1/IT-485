<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Gallery.aspx.cs" Inherits="IT485Proj.Gallery" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
     <h2><%: Title %>.</h2>
    These are some artworks at the THEARTSTORE. Visit our gallery of Equisite artworks!
    <br />
    <!--1st row start -->
    <div class="row">
        <div class="col-md-4">
